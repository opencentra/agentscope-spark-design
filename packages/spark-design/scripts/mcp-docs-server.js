...
var package_default = {
  ...
  scripts: {
    ...
    "docs:build:gh": "GITHUB_PAGES=true dumi build",
  ...
  devDependencies: {
    ...
    debug: "^4.3.7",
    dumi: "^2.3.0",
    "dumi-plugin-code-snippets": "^1.2.0",
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.3/node_modules/@modelcontextprotocol/sdk/dist/esm/types.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.3/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/protocol.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.3/node_modules/@modelcontextprotocol/sdk/dist/esm/server/index.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.3/node_modules/@modelcontextprotocol/sdk/dist/esm/server/completable.js
var McpZodTypeKind;
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.3/node_modules/@modelcontextprotocol/sdk/dist/esm/server/mcp.js
var McpServer = class {
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.3/node_modules/@modelcontextprotocol/sdk/dist/esm/server/stdio.js
var import_node_process = __toESM(require("node:process"), 1);

// node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.3/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/stdio.js
...
var dirname = typeof __dirname !== "undefined" ? __dirname : import_path.default.dirname(process.argv[1]);
function readDocs(name) {
  try {
    const docsPath = import_path.default.join(dirname, "../llms/components/commonComponents", name, "index.zh-CN.llms.txt");
    const docs = import_fs.default.readFileSync(docsPath, "utf-8");
    return docs;
  } catch (error) {
...
function readComponents() {
  try {
    const componentsPath = import_path.default.join(dirname, "../llms/components/commonComponents");
    const items = import_fs.default.readdirSync(componentsPath);
    const folders = items.filter((item) => {
      const itemPath = import_path.default.join(componentsPath, item);
      return import_fs.default.statSync(itemPath).isDirectory();
    });
    return folders.join("\n");
  } catch (error) {
    return `\u7EC4\u4EF6\u76EE\u5F55\u4E0D\u5B58\u5728\u6216\u8BFB\u53D6\u5931\u8D25`;
...
function startMcpServer() {
  ...
  server.registerTool(
    "get_component_docs",
    {
      ...
      inputSchema: {
        name: external_exports.string().default("").describe(`${package_default.name}\u7EC4\u4EF6\u540D\u79F0`)
      }
    },
    async function({ name }) {
