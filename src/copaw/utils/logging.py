...
def setup_logger(level: int | str = logging.INFO):
    ...
    # Enable httpx debug logging to see LLM request/response
    ...
    # Enable httpcore debug logging for raw HTTP traffic
    httpcore_logger = logging.getLogger("httpcore")
    httpcore_logger.setLevel(logging.DEBUG)
    httpcore_logger.propagate = False
    if not httpcore_logger.handlers:
        httpcore_handler = logging.StreamHandler()
        httpcore_handler.setFormatter(formatter)
