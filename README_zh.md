...
基于copaw的定制化项目,用以适配精准AI自动化需求,为了减少不必要的token消耗,优化了报文结构,实际测算token消耗减小了90%,相比于openclaw节省token消耗更多.

<div align="center">

# OpenCentra

[![GitHub 仓库](https://img.shields.io/badge/GitHub-仓库-black.svg?logo=github)](https://github.com/opencentra/opencentra)
...
**安装后:**
```bash
copaw init --defaults   # 或者: opencentra init --defaults
copaw app               # 或者: opencentra app
```
