...
import { EditorRefProps } from '@agentscope-ai/design/lib/components/commonComponents/SlateEditor';
...
import VariableTreeSelect, { IVarTreeItem } from '../variable-tree-select';
import './index.less';
        ...
        (code: string) => {
          ...
          return (
            <span className="inline-flex gap-[2px] spark-flow-var-input-var-tag">
              {nodeSchemaMap[nodeType]?.iconType({
      ...
      return (
        <div
          ...
          className={classNames(
            'spark-flow-var-input-text-area relative',
            {
