...
export interface SparkDrawerProps extends DrawerProps {
  /**
   * @description 是否显示分割线
...
type CompoundedComponent = React.FC<SparkDrawerProps> & {
  Confirm: typeof SparkConfirm;
};

const SparkDrawer: React.FC<SparkDrawerProps> = (props) => {
  const {
    children,
    className,
    style,
...
Object.assign(SparkDrawer, {
  Confirm: SparkConfirm,
});

export default SparkDrawer as CompoundedComponent;
