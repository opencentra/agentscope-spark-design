...
function ComposedProvider(props) {
  var options = props.options,
    cards = props.cards,
    children = props.children;
  var providers = [[ChatAnywhereI18nContextProvider, {
    defaultLocale: options.theme.locale
  }], [ChatAnywhereOptionsContextProvider, {
    options: options
  }], [CustomCardsProvider, {
    cardConfig: cards
  }], [ChatAnywhereSessionsContextProvider, {}], [ChatAnywhereMessagesContextProvider, {}], [ChatAnywhereInputContextProvider, {}], [ChatAnyWhereLayoutContextProvider, {}]];
  ...
  function (children, _ref) {
    var _ref2 = _slicedToArray(_ref, 2),
      Provider = _ref2[0],
      props = _ref2[1];
    return /*#__PURE__*/_jsx(Provider, _objectSpread(_objectSpread({}, props), {}, {
      children: children
    }));
  }, children);
}
